...
%redundant maybe, also described in existing solution
...
%would "many" be ok instead of "countless"
...
\begin{itemize}
  ...
  \item \texttt{Docker} will be used to unify the several layers of this application into a holistic program. %not sure if holistic the right word here. maybe coherent?
\end{itemize}

% need to modify tensorflow spelling
% the diagram is very beautiful :D
\includegraphics[width=\textwidth]{architecture_diagram.png}

%whai have the curly bois gone weird in the pdf? " " 
...
\begin{itemize}
  ...
  \item Offers an outlet for shy students to ask individual questions. %for students to ask individual questions in private
\end{itemize}
...
The chatbot will be continuously trained and personalized to fit students' needs, as well as provide meaningful quizzes to students. Students can conveniently examine themselves and compensate their weakness.%not quite sure how to word this
